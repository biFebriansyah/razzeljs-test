...
function CardsPrice(props) {
    ...
    return (
        <div className="item">
            <section
                className={`panel panel-info cards ${isActive}`}
                ref={cradsRef}
                onClick={ClickCards}
            >
                <h3>{props.title}</h3>
                ...
                <div className="idr" style={{ textAlign: "center" }}>
                    <h1>IDR {props.price ? props.price : 0} K</h1>
                    <h4>/{duraasi}</h4>
                </div>
                ...
                <button className="login-btn" onClick={btnBuy}>
                    <span className="text">Buy</span>
                    <i
                        className="fa fa-spin fa-spinner text-active"
                        style={{ marginRight: "10px" }}
                    />
                    <span className="text-active">Login..</span>
                </button>
            </section>
        </div>
    )
